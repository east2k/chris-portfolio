...
const Header = () => {
    ...
    return (
        ...
        >
            ...
            <div className="bg-linear-to-r from-electric-violet-600 via-charm-500 to-electric-violet-400 rounded-full p-0.5 shadow-lg shadow-electric-violet-500/20">
            ...
            <Link href="#contact-me-section">
                <motion.button
                    whileTap={{ scale: 0.95 }}
                    className="cursor-pointer bg-linear-to-r from-electric-violet-600 via-75% via-charm-500 to-100% to-electric-violet-400 px-10 py-4 rounded-full text-sm font-medium shadow-lg shadow-electric-violet-500/30 hover:shadow-xl hover:shadow-electric-violet-500/50 transition-all duration-300"
                >
                    Contact Me
                </motion.button>
            </Link>
