...
const CTASection = () => {
    return (
        <motion.div
            ...
            className="flex flex-col max-w-screen-2xl mx-auto text-zinc-50 p-7 mb-20"
        >
            <div
                className={`relative overflow-hidden rounded-2xl bg-violet-950/50 border border-zinc-800/50 p-12 backdrop-blur-sm`}
            >
